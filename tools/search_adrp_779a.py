...
with open(kc_path, 'rb') as kc:
    ...
    print("Searching for ADRP pointing to 0x779a000...")
        ...
        if 'TEXT' in sname:
            ...
            for ins in md.disasm(code, vm):
                if ins.mnemonic == 'adrp':
                    ...
                    # ADRP immediate is already resolved by capstone in ins.op_str or operands
                    if '0xfffffe000779a000' in ins.op_str:
