...
# 0xfffffe0008aafca0:0xfffffe0008aafcbc — thread_call_setup_with_qos: redirect b.ne invalid QoS panic
#   directly to mov w8, #3 (safe default QoS) and store, avoiding "Invalid thread call qos value" panic.
