...
TXT_VA=0xfffffe0007a94000; TXT_FOFF=0xa90000; TXT_SZ=0x183c000
TGT=0xfffffe0007043785  # "panic(cpu"
...
for ins in md.disasm(f[TXT_FOFF:TXT_FOFF+TXT_SZ],TXT_VA):
    if ins.mnemonic=="adrp":
        ...
        try:
            ...
            if bn in adrp and abs(adrp[bn]+ins.operands[2].imm-TGT)<0x20:
                hits.append(ins.address)
        except: pass
print("xrefs to panic(cpu string:",[hex(h) for h in hits])
