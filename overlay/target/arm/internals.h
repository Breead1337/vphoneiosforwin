...
{
    /* SPRR_CONFIG_EL1 governs the whole EL1&0 regime (EL0 and TXM's GL0 included) */
    return env->sprr.sprr_config_el[MAX(arm_current_el(env), 1)] & 1;
}
