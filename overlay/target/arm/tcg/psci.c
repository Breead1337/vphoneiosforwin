...
void arm_handle_psci_call(ARMCPU *cpu)
{
    ...
    /* vresearch101 debug: log every HVC/PSCI call with args + caller (LR/PC/ELR). */
    qemu_log_mask(LOG_UNIMP,
        "HVC/PSCI x0=%#" PRIx64 " x1=%#" PRIx64 " x2=%#" PRIx64 " x3=%#" PRIx64
        " x4=%#" PRIx64 " x5=%#" PRIx64 " x6=%#" PRIx64 " x7=%#" PRIx64
        " lr=%#" PRIx64 " pc=%#" PRIx64 " elr1=%#" PRIx64 " elr2=%#" PRIx64 " el=%d\n",
        (uint64_t)env->xregs[0], (uint64_t)env->xregs[1], (uint64_t)env->xregs[2],
        (uint64_t)env->xregs[3], (uint64_t)env->xregs[4], (uint64_t)env->xregs[5],
        (uint64_t)env->xregs[6], (uint64_t)env->xregs[7], (uint64_t)env->xregs[30],
        (uint64_t)env->pc, (uint64_t)env->elr_el[1], (uint64_t)env->elr_el[2],
        arm_current_el(env));
